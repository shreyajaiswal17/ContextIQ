...
export default function Sidebar({ 
  ...
  return (
    <>
      ...
      <aside 
        className={`
          fixed top-14 bottom-0 left-0 z-40 w-72 sm:w-76 bg-slate-900 border-r border-slate-800 
      ...
      >
        <div className="flex-1 overflow-y-auto p-3 space-y-3">
          ...
          <div className="flex items-center justify-between pb-2 border-b border-slate-800">
            ...
            <button 
              onClick={onClose}
              className="p-1 rounded text-slate-400 hover:text-white hover:bg-slate-800 md:hidden"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-9 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-slate-600 transition-colors"
            />
          </div>
          ...
          <div className="space-y-0.5">
            {filteredTopics.map((topic, i) => (
              <button
                ...
                className="w-full text-left px-2.5 py-2 rounded-md text-slate-300 hover:text-white hover:bg-slate-800/90 transition-colors flex items-center justify-between text-xs group"
              >
                <div className="flex items-center gap-2 truncate">
                  <Hash className="w-3.5 h-3.5 text-slate-500 shrink-0 group-hover:text-slate-400" />
